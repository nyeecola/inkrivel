...
class CharactersTest < ApplicationSystemTestCase
  ...
  test "creating a Character" do
    ...
    fill_in "Attack Speed", with: @character.attack_speed
    fill_in "Damage", with: @character.damage
    fill_in "Hit Points", with: @character.hit_points
    fill_in "Hitbox Radius", with: @character.hitbox_radius
    fill_in "Model File", with: @character.model_file
    fill_in "Name", with: @character.name
    fill_in "Speed", with: @character.speed
    fill_in "Texture File", with: @character.texture_file
